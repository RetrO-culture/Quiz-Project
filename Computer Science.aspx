<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Computer Science.aspx.cs" Inherits="Tri_7_Project.Computer_Science" %>
    ...
    <form id="form1" runat="server" style="font-family: 'Bahnschrift SemiBold'; font-size: large; font-weight: bold">
        ...
        <div>
            <table class="container4" align ="center">
                ...
                <tr>
                    <td>
                        <asp:RadioButton GroupName="q1" ID="RadioButton1" runat="server" Text="1" /></td>
                </tr>
                <tr>
                    <td>
                        <asp:RadioButton GroupName="q1" ID="RadioButton2" runat="server" Text="2" />
                    </td>
                ...
                <tr>
                    <td>
                        <asp:RadioButton GroupName="q1" ID="RadioButton3" runat="server" Text="3" /></td>
                </tr>
                <tr>
                    <td>
                        <asp:RadioButton GroupName="q1" ID="RadioButton4" runat="server" Text="4" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <asp:RadioButton GroupName="q2" ID="RadioButton5" runat="server" Text="1" /></td>
                </tr>
                <tr>
                    <td>
                        <asp:RadioButton GroupName="q2" ID="RadioButton6" runat="server" Text="2" /></td>
                </tr>
                <tr>
                    <td>
                        <asp:RadioButton GroupName="q2" ID="RadioButton7" runat="server" Text="3" /></td>
                </tr>
                <tr>
                    <td>
                        <asp:RadioButton GroupName="q2" ID="RadioButton8" runat="server" Text="4" />
                        <br />
                        <br />
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <asp:RadioButton ID="RadioButton9" runat="server" Text="1" /></td>
                </tr>
                <tr>
                    <td>
                        <asp:RadioButton ID="RadioButton10" runat="server" Text="2" /></td>
                </tr>
                <tr>
                    <td>
                        <asp:RadioButton ID="RadioButton11" runat="server" Text="3" /></td>
                </tr>
                <tr>
                    <td>
                        <asp:RadioButton ID="RadioButton12" runat="server" Text="4" />
                        <br />
                        <br />
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <asp:RadioButton ID="RadioButton13" runat="server" Text="1" /></td>
                </tr>
                <tr>
                    <td>
                        <asp:RadioButton ID="RadioButton14" runat="server" Text="2" /></td>
                </tr>
                <tr>
                    <td>
